...
The system will allow users to browse and buy items from different stores in one website. The different stores can include fast fashion and second hand options, in addition to that a vegan and small/local creators filter when shopping for items. This helps customers be more eco friendly and choose to help the local community as we give them options to do so. Allowing all stores on one platform is time efficient for the customers and optimizes shipment.

### Pages

* Home page: contains a message about our shops and showing how we are different from other similar websites. 
* Catalogue page: contains all the items in all the stores for the customer to browse easily. On the top of the page there is a search bar with filters (second hand, vegan, etc).
